<html>
    ...
    <body>
        ...
        <ol>
            ...
            <input type="checkbox" name="Taiwanese food">台式(Taiwanese food)
            <input type="checkbox" name="Chinese food">中式(Chinese food)
            <input type="checkbox" name="Fast food">速食(Fast food)
            <input type="checkbox" name="Western-style food">西式(Western-style food)
            <input type="checkbox" name="French Food">法式(French Food)
            <input type="checkbox" name="Vegetarian diet">素食(Vegetarian diet)
            <input type="checkbox" name="Fried food">炸物(Fried food)
            <input type="checkbox" name="Dessert">甜點(Dessert)
            <input type="checkbox" name="Seafood">海鮮(Seafood)
            <input type="checkbox" name="Street food">小吃(Street food)<br><br>
            ...
            T恤顏色(T-shirt color)：<input type="text" name="username" placeholder="color" required><br><br>
